          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                const FittedBox(
                    fit: BoxFit.fitWidth,
                    child: Text(' NTU Mart ', style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700))
                ),
                const SizedBox(
                    width: 10
                ),
                ElevatedButton(
                  onPressed: (){
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Add in chatbot navigation later"),
            ...
            Padding(
              ...
              child: SearchBar(
                ...
                surfaceTintColor: const MaterialStatePropertyAll<Color>(Color(0xFFF9F9F9)
                ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget> [
                  const FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Text(' Your Categories ', style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600))
                  ),
                  const SizedBox(
                      width: 5,
                  ),
                  ElevatedButton(
                    onPressed: (){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Sort function will be added l8r'),
                          duration: Duration(milliseconds: 1500),
                          behavior: SnackBarBehavior.floating,
                        ),
                      );
                    ...
                    style: ButtonStyle(
                      ...
                      backgroundColor: const MaterialStatePropertyAll<Color>(Color(0xFFFFFFFF)),
                      fixedSize: MaterialStateProperty.all( const Size(double.infinity, 30.0)
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        const Text('Sort',
                          style: TextStyle(color: Color(0xFF5D7395), fontWeight: FontWeight.w600, fontSize: 15),
                        ),
                        RotatedBox(
                            quarterTurns: 1,
                  ...
                  ElevatedButton(
                    onPressed: (){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Filter function will be added l8r'),
                          duration: Duration(milliseconds: 1500),
                          behavior: SnackBarBehavior.floating,
                        ),
                      );
