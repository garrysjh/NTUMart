                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Image.asset(
                                  'assets/img/product${index + 1}.jpg');
                            },
                          ),
                        ),
                        ...
                        const Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                  height: 12.0), // Adjust the spacing as needed
                              Text(
                        ...
                        Center(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: const Color(
                                  0xFFF3F3F3), // Set the background color
                              ...
                              children: <Widget>[
                                const Row(
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                        width:
                                            12.0), // Increase the space between the avatar and text
                                    // Bold the username
                                    Text(
                                      'Miyamura Izumi',
                                      style: TextStyle(
                                ...
                                const SizedBox(
                                    height:
                                        20.0), // Increase the space between rows
                                Row(
                                  children: <Widget>[
                                    Image.asset('assets/img/telegram.png',
                                        height: 14.0), // Make icons smaller
                                ...
                                Row(
                                  children: <Widget>[
                                    Image.asset('assets/img/dollar-symbol.png',
                                        height: 14.0),
                                    const SizedBox(width: 12.0),
                                    const Text(
                        ...
                        const SizedBox(
                            height:
                                0.0), //space between "Seller details" and "Contact seller" button
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Expanded(
                                child:
                                    Container(), // Empty container to create spacing
                              ),
                              Expanded(
