...
class _RoomChatPageState extends State<RoomChatPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(padding: EdgeInsets.only(top:60, left: 20, right: 20), child: Stack( children: <Widget>[Column(
        children:<Widget>[
          Align(alignment: Alignment.centerLeft, child: Text("Stories from $hallRoom",
          style: const TextStyle(
            fontSize: 30,
            fontWeight: FontWeight.w600, color: Color(0xFF5C795B)
          ))),
          const Padding(padding: EdgeInsets.only(top: 10, bottom: 20), child: Text('Tap to find out what is happening in your hall, or who is moving out!',
          style: TextStyle(
            fontSize: 16
          ))),
          Row(children: <Widget>[
  ...
  child: ClipOval(
    child: InkWell(onTap: (){
      ...
      child: Image.asset('assets/img/product1.jpg', fit: BoxFit.cover),
    )),
  ),
), Padding(padding:EdgeInsets.only(top: 10), child: Text(hallRoom, style: TextStyle(fontWeight: FontWeight.w400, color: Color(0xFF5C795B))))]),
Padding(
...
Navigator.of(context).push(
      ...
      child: Image.asset('assets/img/avatar.jpg', fit: BoxFit.cover),
          ...
          const Padding(padding: EdgeInsets.only(top: 10, bottom: 20), child: Text('Tap to leave a message for your room, find out who is moving in, or offer to sell an item directly to your future roomie! Messages will disappear in a week.',
          style: TextStyle(
            fontSize: 16
          ))),
          SizedBox(
            ...
            children: <Widget>[
              for (var i in posts.keys) Padding( padding: EdgeInsets.symmetric(horizontal: 10), child:Container(
  width: 150,
  ...
  child: Column(children:<Widget>[ Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: 20, right: 20, top: 5), child: Text(
    i,
    style: TextStyle(
  ...
  )), Padding(padding: EdgeInsets.all(10), child: SizedBox(child: Text(posts[i] ?? 'Post was empty')))]),
))
            ]
            )
      ...
      Positioned(
            ...
            children: <Widget>[Align(alignment: Alignment.centerLeft, child: ElevatedButton(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setState) {
            return AlertDialog(
              title: const Padding(padding: EdgeInsets.only(top:20), child: Text('Which hall do you stay in?', style: TextStyle(
                                          fontSize: 24,
