...
public class ProductApiController {
  ...
  public ResponseEntity<String> updateProduct(
    ...
    productService.updateProduct(
        productID, productDTO, productPicture, productPicture2, productPicture3, productPicture4);
    return ResponseEntity.ok("Product updated successfully");
  }

  // INCREASE ProductLikes
  @PutMapping("/{productID}/uplike")
  public ResponseEntity<Product> incrementProductLikes(@PathVariable int productID)
      throws ProductNotFoundException {
  ...
  public ResponseEntity<Product> decrementProductLikes(@PathVariable int productID)
      throws ProductNotFoundException {
