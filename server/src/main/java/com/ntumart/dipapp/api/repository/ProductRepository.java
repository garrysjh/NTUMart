...
public interface ProductRepository extends JpaRepository<Product, Integer> {
  ...
  @Query(
      value =
          "INSERT INTO PRODUCT(:sellerID, :name, :description, :price, :quantity, :data, :productPic, :productPic2, :productPic3, :productPic4, :date, :category)",
      nativeQuery = true)
  int addProduct(
  ...
  @Query(
      value =
          "UPDATE product SET sellerID = :sellerID, name = :name , description = :description , price = :price , quantity = :quantity , data = :data ,  productPic = :productPic , productPic2 = :productPic2 , productPic3 = :productPic3 , productPic4 = :productPic4 , date = :date, category = :category",
      nativeQuery = true)
  int updateProduct(
      @Param("sellerID") int sellerID,
      @Param("name") String name,
  ...
  @Query(
      value = "UPDATE PRODUCT SET productLikes = :productLikes + 1 WHERE productID = :productID",
      nativeQuery = true)
