...
public interface InterestRepository extends JpaRepository<Interest, Integer> {
  ...
  @Query(
      value =
          "INSERT INTO INTEREST(:userID, :category1, :category2, :category3, :category4, :category5)",
      nativeQuery = true)
  int addInterest(
  ...
  @Query(
      value =
          "SELECT * FROM USER INNER JOIN INTEREST ON USER.userID = INTEREST.userID where INTEREST.userID = :userID",
      nativeQuery = true)
  ...
  @Query(
      value =
          "UPDATE product SET category1 = :category1, category2 = :category2, category3 = :category3, category4 = :category4, category5 = :category5 WHERE userID = :userID",
      nativeQuery = true)
  int updateProduct(
      @Param("userID") int userID,
      @Param("category1") String category1,
