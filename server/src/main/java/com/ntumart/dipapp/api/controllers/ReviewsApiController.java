...
public class ReviewsApiController {
  ...
  public ResponseEntity<String> addReview(
      @RequestBody Reviews reviews, @RequestHeader("Authorization") String token) {
    try {
  ...
  public ResponseEntity<String> updateReview(
    ...
    try {
      ...
      if (reviewerId != reviewsService.getReviewerIDFromReviewID(reviews)) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Not authorised to edit review");
      }
